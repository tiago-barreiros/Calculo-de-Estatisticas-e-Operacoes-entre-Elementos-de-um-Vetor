...
# Cálculo de Estatísticas e Operações entre Elementos de um Vetor

<table>
<tr>
<td>
  Criação de um programa que permite ao utilizador usufruir de diversas funcionalidades matemáticas, muito importantes no dia a dia.
</td>
</tr>
</table>
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/Calculo-de-Estatisticas-e-Operacoes-entre-Elementos-de-um-Vetor
...
## [Prof. Doutor Pedro R. M. Inácio](https://www.di.ubi.pt/~inacio/)

## *Laboratórios de Programação* @[Universidade da Beira Interior](https://www.ubi.pt/).
